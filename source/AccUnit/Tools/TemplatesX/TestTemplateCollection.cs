...
namespace AccessCodeLib.AccUnit.Tools.Templates
{
    public class TestTemplateCollection : CodeTemplateCollection
    {
        ...
        private void LoadBuiltInTemplates()
        {
            ...
            {
                Logger.Log("===== 1 ========");
                Add(new CodeTemplate(BuiltInTemplateSources.AccUnitTestClassName,
                                     BuiltInTemplateSources.AccUnitTestClassSource,
                                     BuiltInTemplateSources.AccUnitTestClassCaption,
                                     true));
                Logger.Log("===== 2 ========");
