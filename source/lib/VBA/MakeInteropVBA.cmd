...
REM Generate Interop.VBA.dll by forcing it to reference the .NET 2.0 runtime. Current versions of Visual Studio would use the .NET 4 runtime, causing problems with compilation down stream.
...
"%WinSdkPath%\TlbImp.exe" "C:\Windows\SysWOW64\msvbvm60.dll" /out:%CurrDir%Interop.VBA.dll /namespace:VBA
